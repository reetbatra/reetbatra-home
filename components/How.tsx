...
const pillars = [
  {
    ...
    body: "TypeScript, Python, Next.js, React Native. The agent, the interface, the deploy, and the cron job that keeps it honest. Ten-plus shipped in the last year, nearly all of them alone.",
  ...
  },
  {
    ...
    body: "Every product on this page has one deliberate no in it. AskTota chose print over cosmos. Nudge skipped signup entirely. Muscle Mommy refuses a weight jump that's secretly a doubling. What I left out is the product.",
  ...
  },
  {
    ...
    body: "Four years of developer marketing. An 11-city workshop tour that reached 4,800 developers, a video series landing 4K to 8K views an episode, a $21K grants program, and now a reels engine that posts every night for AskTota.",
