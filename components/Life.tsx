  ...
  return (
    <section id="life" className="mx-auto max-w-[1200px] px-5 py-20 sm:px-8 md:py-28">
      ...
      <div className="mt-14 grid gap-5 md:grid-cols-6">
        {/* Travel */}
        <article className="reveal relative overflow-hidden rounded-3xl bg-ink p-8 text-paper md:col-span-4 md:min-h-[340px]">
          <div
            aria-hidden
          ...
          <div className="relative flex h-full flex-col">
            ...
            <p className="mt-4 max-w-[480px] font-sans text-[15px] leading-[1.7] text-[#c8bcb0]">
        ...
        <article className="reveal flex flex-col rounded-3xl border border-line-2 bg-paper p-8 md:col-span-2">
          ...
          <p className="mt-3 flex-1 font-sans text-[14.5px] leading-[1.7] text-muted">
            ...
            next set before I ask.
          </p>
          <a
            href="#work"
            className="mt-5 inline-flex min-h-11 items-center gap-1.5 self-start font-mono text-[11px] uppercase tracking-[0.1em] text-clay transition-colors hover:text-clay-dark"
          >
            Muscle Mommy, above
